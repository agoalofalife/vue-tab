<template>
    <div>
        <div id="wrapper" v-bind:class="{ 'toggled' : showSidebar }" >
            ...
            <div id="page-content-wrapper">
                <button type="button" v-bind:class="{  'is-open' : showSidebar , 'is-closed' : !showSidebar }" class="hamburger " data-toggle="offcanvas" @click="change">
...
<script>
    export default{
        ...
        methods:{
            change(){
                this.showSidebar ?  this.$refs.overlay.style.display = 'none' :  this.$refs.overlay.style.display = 'block';
